                    ...
                    auth.createUserWithEmailAndPassword(email, pass).addOnCompleteListener(SignUpActivity.this, new OnCompleteListener<AuthResult>() {
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            if (!task.isSuccessful()) {
                                ...
                                Userinformation userinformation = new Userinformation(name, email, phoneNumber);
                                ...
                                //databaseRef.child(user.getUid()).setValue(userinformation);
                                userRef = database.getReference("users/" + user.getUid());
                                userRef.setValue(userinformation);
                                //userRef.child(user.getUid()).setValue(userinformation);
